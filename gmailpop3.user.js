// ==UserScript==
// @name           Gmail Check POP3 Mail Now - Static
// @author         Thomas Kent
// @version        2022.09.20
// @namespace      http://teeks99.com/
...
/*
	...
	Copyright (C) 2024 Daniel Slaughter, LLC. All Rights Reserved.
	Copyright (C) 2024 Thomas Kent. All Rights Reserved.
...
(function() {
	...
	var o = {
		...
		core:
// From gmailPop3CheckerPretty.js
// Changing indent to match other file
{
	...
	setting: {
		// MODIFIED - Settings from top of script
	...
	account: function () {
		...
		var responseFunc = function (r) {
			...
			// MODIFIED - Policy was needed
			var policy = trustedTypes.defaultPolicy ?? trustedTypes.createPolicy("default", {
				createHTML: (to_escape) => to_escape,
				createScript: (to_escape) => to_escape,
			});
			temp.innerHTML = policy.createScript('window.gmpc_core = ' + r.responseText);
			// END MODIFIED
